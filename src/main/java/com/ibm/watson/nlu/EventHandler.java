...
// tag::code[]
@Component
@RepositoryEventHandler(Nlu.class)
public class EventHandler {
	...
	@HandleAfterCreate
	public void newNlu(Nlu employee) {
		this.websocket.convertAndSend(
				MESSAGE_PREFIX + "/newNlu", getPath(employee));
	}

	@HandleAfterDelete
	public void deleteNlu(Nlu employee) {
		this.websocket.convertAndSend(
				MESSAGE_PREFIX + "/deleteNlu", getPath(employee));
	}

	@HandleAfterSave
	public void updateNlu(Nlu employee) {
		this.websocket.convertAndSend(
	 ...
	 * @param employee
	 */
	private String getPath(Nlu employee) {
