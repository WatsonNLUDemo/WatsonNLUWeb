 ...
 */
// tag::code[]
public interface NlusumRepository extends PagingAndSortingRepository<Nlusum, Long> {

  public Page findByitemContainingIgnoreCase(@Param("item") String item, Pageable p);

  public Page findByitemContainingIgnoreCaseOrderByItemAsc(@Param("item") String item, Pageable p);
  public Page findByitemContainingIgnoreCaseOrderByItemDesc(@Param("item") String item, Pageable p);
...
//  public Page findByitemContainingIgnoreCaseAndItemtextContainingIgnoreCaseOrderByCountDesc(@Param("item") String item, @Param("itemtext") String itemtext, Pageable p);
